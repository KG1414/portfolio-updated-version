...
const projectData = [
    {
        ...
        projectDescription: "Current Website to showcase some of my recent projects. Created with custom features including the carousel and these cards. The Contact Me form uses NodeMailer API and there is also an inconspicuous Weather API via WeatherStack to be found. Note weather API will not be called to display integer if it's been clicked on too many times during the month.",
    ...
    },
    {
        ...
        linkTwo: "https://codesandbox.io/s/jtzym",
        badgeOne: "React",
        badgeTwo: "JS",
        badgeThree: "Express",
        badgeFour: "CSS",
