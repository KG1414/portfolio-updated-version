...
const projectData = [
    {
        ...
        projectDescription: "Current Website made with React.js to showcase some of my recent projects. Created with custom features including the carousel and these cards. The Contact Me form uses the getform.io API  (formerly used NodeMailer API). Used Node and connected front end with backend for API's and to deploy to Heroku.",
